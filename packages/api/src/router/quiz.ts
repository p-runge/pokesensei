...
import type { QuestionWithAnswers } from "../utils/question";
import { createTRPCRouter, publicProcedure } from "../trpc";
import { LANGUAGES_ISO, pokeApi } from "../utils/api";
import { getLocalizedName } from "../utils/common";
import { getQuestionByType } from "../utils/question";
import { getRandomElement } from "../utils/random";
import { withDefaultedProps } from "../utils/zod";
        ...
        const questions = await Promise.all(
          ...
          [...Array<void>(questionAmount)].map(async () => {
            ...
            const questionType: QuestionType =
              getRandomElement<QuestionType>(questionTypes);
